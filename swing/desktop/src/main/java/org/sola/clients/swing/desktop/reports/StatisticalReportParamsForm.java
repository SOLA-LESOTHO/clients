 ...
 * @author ntsane
 */
public class StatisticalReportParamsForm extends javax.swing.JDialog {

    /**
     * Creates new form StatisticalReportParamsForm
     */
    ...
    private void initComponents() {
        ...
        btnFromDate.setText(bundle1.getString("LodgementReportParamsForm.btnFromDate.text")); // NOI18N
        ...
        btnToDate.setText(bundle1.getString("LodgementReportParamsForm.btnToDate.text")); // NOI18N
        ...
        if (dateFilled) {
            ...
            SolaTask<Void, Void> t = new SolaTask<Void, Void>() {
                ...
                public Void doTask() {
                    ...
                    statisticalViewListBean.loadStatisticalSummary(searchParams);
                    return null;
                }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StatisticalReportParamsForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                StatisticalReportParamsForm dialog = new StatisticalReportParamsForm(new javax.swing.JFrame(), true);
