...
<html>
    ...
    <body>
        <table width="80%" cellspacing="0" cellpadding="3">
            <tr>
                <td colspan="2">  
                    <h1><img src="Images/SolaLogo.png"/>Welcome to the download for the SOLA Lesotho Web Start applications.</h1>
                </td>
            </tr>
            <tr>
                <td width="20%"></td>   
                <td> <br><br>
                    ...
                    <br><br>
                    This page will guide you through the installation of the SOLA Lesotho Web Start applications which includes the SOLA Lesotho Desktop and SOLA Lesotho Admin. The installation package for both applications is approximately 100Mb.
                    <br><br> 
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="20%"></td>   
                <td>     
                    The  Java SE Runtime Environment 7 is required for the SOLA Web Start applications. Java 7 can be downloaded from <a href="http://www.oracle.com/technetwork/java/javase/downloads/java-archive-downloads-javase7-521261.html" target="_blank" >here</a>.
                    <ol>
            ...
            <tr>
                ...
                <td>
                    <h2>User Guide</h2>
                    <br>
                    The SOLA Lesotho User Guide provides detailed information on the installation and use of SOLA Lesotho. The User Guide is available from <a href="help/SOLAUserGuide.pdf" target="_blank" >here</a>.
                </td>
            </tr> 
        </table>  
    </body>
